...
<head>
    ...
    <title>Family Tree: Halijah Binti Haji Ahmad</title>
    <link rel="stylesheet" href="/styles.css">
    <link rel="stylesheet" href="/gallery.css">
</head>
<body>
    <a href="/100/che_puteh_binti_ariffin/index.php">Up</a>
    <div class="family-tree">
        <div class="person">
            <img src="/images/female-grey-icon.png" height="100px" alt="icon">
            <div>Halijah Binti <a href="/100/ahmad_bin_lebai_hasan/">Ahmad</a></div>
        </div>
        <div class="marriage">Married</div>
        <div class="partners">
            <div class="person">
                <img src="/images/male-grey-icon.png" height="100px" alt="icon">
                <div><a href="/101/saad_bin_man/">Saad</a> Bin Man</div>
                <div class="children">
                    ...
                    <div class="person"><img src="/images/male-grey-icon.png" height="100px" alt="icon"><div><a href="shahadan_bin_saad/">Shahadan</a></div></div>
